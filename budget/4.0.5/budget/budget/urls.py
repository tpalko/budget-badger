...
urlpatterns = [
    ...
    re_path(r'account/(?P<tenant_id>[0-9]+)/transactionruleset/(?P<transactionruleset_id>[0-9]+)/delete', views.transactionruleset_delete, name="transactionruleset_delete"),
    re_path(r'account/(?P<tenant_id>[0-9]+)/transactionruleset/(?P<transactionruleset_id>[0-9]+)/edit', views.transactionruleset_edit, name="transactionruleset_edit"),
    ...
    re_path(r'account/(?P<tenant_id>[0-9]+)/prototransactions/', views.prototransactions, name="prototransactions"),    
    re_path(r'account/(?P<tenant_id>[0-9]+)/history/', views.history, name="history"),    
    ...
    re_path(r'account/(?P<tenant_id>[0-9]+)/files/(?P<uploadedfile_id>[0-9]+)/(?P<action>.+)/', views.reprocess_files, name="reprocess_files"),    
    re_path(r'account/(?P<tenant_id>[0-9]+)/files/(?P<action>.+)/', views.reprocess_files, name="reprocess_files"),
    re_path(r'account/(?P<tenant_id>[0-9]+)/files/', views.files, name="files"),        
    re_path(r'account/(?P<tenant_id>[0-9]+)/record_typing/(?P<search>.+)/', views.record_typing, name="record_typing"),        
    re_path(r'account/(?P<tenant_id>[0-9]+)/record_typing/', views.record_typing, name="record_typing"),        
    re_path(r'account/(?P<tenant_id>[0-9]+)/record/meta', views.update_record_meta, name="update_record_meta"),        
    ...
    re_path(r'account/(?P<tenant_id>[0-9]+)/taxes/(?P<tax_year>[0-9]+)/', views.taxes, name='taxes'),
    re_path(r'account/(?P<tenant_id>[0-9]+)/taxes/', views.taxes, name='taxes'),
