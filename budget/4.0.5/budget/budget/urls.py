...
urlpatterns = [
    ...
    re_path(r'account/(?P<tenant_id>[0-9]+)/account/(?P<account_id>[0-9]+)/', views.account_edit, name="account_edit"),    
    re_path(r'account/(?P<tenant_id>[0-9]+)/account/', views.account_edit, name="account_edit"),
    re_path(r'account/(?P<tenant_id>[0-9]+)/accounts/', views.accounts, name="accounts"),    
