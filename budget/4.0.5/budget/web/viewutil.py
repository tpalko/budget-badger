...
def get_recordgroup_data():
    ...
    record_group_exclude_columns = ['records', 'recent_amounts', 'weights', 'hist', 'bins', 'min_amount', 'max_amount', 'avg_amount', 'outliers_removed', 'is_variable', 'average_gap', 'five_percent', 'ten_percent', 'most_frequent_date', 'most_frequent_date_probability']
